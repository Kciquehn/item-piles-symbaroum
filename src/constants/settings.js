...
const SETTINGS = {
	...
	MERCHANT_ITEM_CATEGORIES: "merchantItemCategories",
	...
	DEFAULTS: () => ({
		...
		[SETTINGS.PRICE_PRESETS]: {
			...
			config: false,
			default: SYMBAROUM_ITEM_GROUPS,
			type: Array
		},

		[SETTINGS.MERCHANT_ITEM_CATEGORIES]: {
			name: "ITEM-PILES.Settings.MerchantItemCategories.Title",
			label: "ITEM-PILES.Settings.MerchantItemCategories.Label",
			hint: "ITEM-PILES.Settings.MerchantItemCategories.Hint",
			scope: "world",
			icon: "fa fa-store",
			application: "merchant-item-categories",
			config: false,
			default: SYMBAROUM_MERCHANT_CATEGORIES,
			type: Array
		},
