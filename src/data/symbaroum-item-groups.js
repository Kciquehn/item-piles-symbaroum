...
group("weapons-common", "Armas Comuns", { itemTypes: ["weapon"], maxItems: 16, minQuantity: 1, maxQuantity: 3 }),
group("weapons-quality", "Armas de Alta Qualidade", { itemTypes: ["weapon"], maxItems: 8, minQuantity: 1, maxQuantity: 2, chance: 55 }),
...
group("armor-common", "Armaduras Comuns", { itemTypes: ["armor", "equipment"], maxItems: 12, minQuantity: 1, maxQuantity: 3 }),
group("armor-quality", "Armaduras de Alta Qualidade", { itemTypes: ["armor", "equipment"], maxItems: 8, minQuantity: 1, maxQuantity: 2, chance: 55 }),
